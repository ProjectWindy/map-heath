...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void _incrementDate() {
    ...
    dateProvider.checkAndDisplayWaterData(); // Lấy dữ liệu mới cho ngày mới
  }
            ...
            return FadeTransition(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  //               onTap: () {
                  //                 Provider.of<DateProvider>(context, listen: false).decrementDate();
                  //                 },
                  //               child: const Center(
                  //                 child: Icon(
                  //                   Icons.keyboard_arrow_left,
                  ...
                  //                 ),
                  //                 Text(
                  //                   DateFormat('yyyy-MM-dd').format(Provider.of<DateProvider>(context, listen: false).selectedDate)
                  //                   ,textAlign: TextAlign.left,
                  //                   style: const TextStyle(
                  //                     fontFamily: FitnessAppTheme.fontName,
                  //                     fontWeight: FontWeight.normal,
                  ...
                  //                   Radius.circular(32.0)),
                  //               onTap: () {
                  //                 Provider.of<DateProvider>(context, listen: false).incrementDate();
                  //                 },
                  //               child: const Center(
                  //                 child: Icon(
                  //                   Icons.keyboard_arrow_right,
